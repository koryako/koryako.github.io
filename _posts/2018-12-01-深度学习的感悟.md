...
![gnsi](https://github.com/koryako/koryako.github.io/blob/master/img/in-post/post-start/junheng.png)

我可以把上图转换为一个公式

![gnsi](../img/in-post/post-start/gongshi.png)
每个输入x和自己的权重W相乘然后相加。这是加权的算法

然后我们对这个和的值设置一个阀值，用于计算这个阀值的函数称为激活函数

![gnsi](../img/in-post/post-start/sigmoid.png)
